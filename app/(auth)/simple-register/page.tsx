              ...
              <div className="flex">
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700">
                    ...
                    {storeInfo && (
                      <div className="mt-2">
                        <p>Store ID: <strong>{storeInfo.id}</strong></p>
                        <p>Store Name: <strong>{storeInfo.name}</strong></p>
                      </div>
                    )}
                    <p className="mt-2">This is a test registration that only creates a store.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Simple Store Creation (No User Registration)
          </p>
          <div className="mt-2 bg-yellow-50 p-2 rounded text-center text-yellow-800 text-sm">
            This is a test page that only creates a store record
          </div>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              {loading ? 'Creating store...' : 'Create test store'}
            </button>
          </div>
