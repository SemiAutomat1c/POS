    ...
    <div className="min-h-screen">
        ...
        <div className="container space-y-8">
                    ...
                    <TableBody>
                      {demoCustomers.map((customer) => (
                        <TableRow key={customer.id}>
                          ...
                          <TableCell>{formatDate(new Date(Date.now() - Math.random() * 10000000000).toString())}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
              ...
              Sign up now to access all features and start managing your inventory efficiently.
            </p>
      ...
      <footer className="bg-muted py-6">
        <div className="container text-center text-sm text-muted-foreground">
          <p>© 2023 GadgetTrack. All rights reserved. Demo version.</p>
        </div>
      </footer>
    </div>
  )
